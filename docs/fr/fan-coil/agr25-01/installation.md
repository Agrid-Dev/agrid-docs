...
!!! warning "Dispositif de sectionnement omnipolaire requis"
...
!!! danger "Limitations des relais — Risque d'incendie"
...
Installer le thermostat au mur, à une hauteur maximale de 2 m par rapport au sol. La hauteur d'installation recommandée se situe à hauteur d'homme, à un emplacement représentatif de la température ambiante de la pièce.
...
1. Desserrer la vis inférieure. Séparer le panneau avant de la platine arrière.
2. Fixer la platine arrière au mur.
3. Procéder au raccordement électrique (voir Bornier ci-dessous et [Configurations de câblage](wiring.md)).
4. Reconnecter le panneau avant et serrer la vis.

!!! note
    Ne pas obstruer les fentes de ventilation du boîtier (nécessaires au bon fonctionnement des capteurs).
...
|---|---|
| FH | Ventilateur vitesse haute |
| FM | Ventilateur vitesse moyenne |
| FL | Ventilateur vitesse basse |
| HV | Vanne chaude |
| CV | Vanne froide |
| HR | Résistance électrique d'appoint |
...
!!! warning "Directive DEEE"
    Ce produit ne doit pas être jeté avec les déchets ménagers. Conformément à la directive DEEE (2012/19/UE), le rapporter à un point de collecte agréé ou au distributeur.
