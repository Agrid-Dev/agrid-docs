...
| `Event` | `enum` | — | NO_EVENT | Dernier événement système remonté par le firmware : boot, Wi-Fi, MQTT, script, téléchargement OTA, opérations flash et actions de configuration.<br>_115 valeurs admises — les lister via `GET /enums`._ |
